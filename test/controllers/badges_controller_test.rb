...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { description: @badge.description, name: @badge.name, rule: @badge.rule, rule_value: @badge.rule_value } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { description: @badge.description, name: @badge.name, rule: @badge.rule, rule_value: @badge.rule_value } }
